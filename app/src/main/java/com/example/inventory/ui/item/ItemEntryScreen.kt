...
fun ItemEntryBody(
    ...
    Column(
        ...
        ItemInputForm(
            ...
            validSupplier = itemUiState.isSupplierValid,
            validSupplierEmail = itemUiState.isSupplierEmailValid,
            validSupplierPhone = itemUiState.isSupplierPhoneValid
        )
        Button(
            onClick = onSaveClick,
